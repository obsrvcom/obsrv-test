...
<div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-neutral-200 dark:border-neutral-700 flex-1 p-6">
        <div class="text-center py-16">
            ...
            <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">{{ __('Billing Coming Soon') }}</h3>
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
                {{ __('Billing and subscription management functionality will be implemented here.') }}
            </p>
        </div>
    </div>
</div>
